...
require_once __DIR__ . '/PrivacyAuditService.php';

final class PluginController
{
    private PrivacyAuditService $service;
    private string $pluginDir;

    public function __construct(string $pluginId, string $pluginDir)
    {
        $this->pluginDir = rtrim($pluginDir, '/\\');
        $this->service = new PrivacyAuditService($pluginId, $pluginDir);
    }
    ...
    private function requireAdminPost(): bool
    {
        ...
        if (
            !Security::rateLimit(
                'privacy_audit_admin:' . Security::clientIpMasked(),
                60,
                30,
            )
        ) {
