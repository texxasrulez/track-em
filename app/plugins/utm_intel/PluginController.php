...
require_once __DIR__ . '/UtmIntelService.php';

final class PluginController
{
    private UtmIntelService $service;
    private string $pluginDir;

    public function __construct(string $pluginId, string $pluginDir)
    {
        $this->pluginDir = rtrim($pluginDir, '/\\');
        $this->service = new UtmIntelService($pluginId, $pluginDir);
    }
    ...
    private function requireAdminPost(): bool
    {
        ...
        if (
            !Security::rateLimit(
                'utm_intel_admin:' . Security::clientIpMasked(),
                60,
                30,
            )
        ) {
