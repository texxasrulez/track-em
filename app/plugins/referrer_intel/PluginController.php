...
require_once __DIR__ . '/ReferrerIntelService.php';

final class PluginController
{
    private ReferrerIntelService $service;
    private string $pluginDir;

    public function __construct(string $pluginId, string $pluginDir)
    {
        $this->pluginDir = rtrim($pluginDir, '/\\');
        $this->service = new ReferrerIntelService($pluginId, $pluginDir);
    }
    ...
    private function requireAdminPost(): bool
    {
        ...
        if (
            !Security::rateLimit(
                'referrer_intel_admin:' . Security::clientIpMasked(),
                60,
                30,
            )
        ) {
