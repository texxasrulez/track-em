...
require_once __DIR__ . '/FunnelReportsService.php';

final class PluginController
{
    private FunnelReportsService $service;
    private string $pluginDir;

    public function __construct(string $pluginId, string $pluginDir)
    {
        $this->pluginDir = rtrim($pluginDir, '/\\');
        $this->service = new FunnelReportsService($pluginId, $pluginDir);
    }
    ...
    private function admin(): bool
    {
        ...
        $eventTrackingAvailable = $this->service->eventTrackingAvailable();
    ...
    private function requireAdminPost(): bool
    {
        ...
        if (!Security::rateLimit('funnel_reports_admin:' . Security::clientIpMasked(), 60, 30)) {
