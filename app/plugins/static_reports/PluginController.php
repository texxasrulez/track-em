...
require_once __DIR__ . '/StaticReportsService.php';

final class PluginController
{
    private StaticReportsService $service;
    private string $pluginDir;

    public function __construct(string $pluginId, string $pluginDir)
    {
        $this->pluginDir = rtrim($pluginDir, '/\\');
        $this->service = new StaticReportsService($pluginId, $pluginDir);
    }
    ...
    private function admin(): bool
    {
        ...
        $autoResult = $this->service->autoGenerateDueReports($config);
    ...
    private function generate(): bool
    {
        ...
        $config = $this->service->loadConfig();
        $result = $this->service->generateRequestedReports($config, [
    ...
    private function view(): bool
    {
        ...
        $path = $this->service->resolveReportPath($file);
    ...
    private function requireAdminPost(): bool
    {
        ...
        if (
            !Security::rateLimit(
                'static_reports_admin:' . Security::clientIpMasked(),
                60,
                30,
            )
        ) {
